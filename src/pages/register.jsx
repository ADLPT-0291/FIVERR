      ...
      <div className="max-w-4xl p-8 rounded-xl shadow-xl bg-[#1F1F2D]">
        <div className="flex flex-row gap-10 ">
          <div className="flex flex-col justify-center items-center ">
            <img src="https://www.naijatechguide.com/wp-content/uploads/2018/10/fiverr-overview.jpeg" className="w-[480px] h-[300px] object-contain" />
          </div>
          <div className="w-[50%]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <label className="text-white">User
                <Input {...register("user")} className="w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-2" />
                {renderError("user")}
              </label>

              <label className="text-white">Password
                <Input type="password" {...register("password")} className="w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-4" />
                {renderError("password")}
              </label>

              <label className="text-white">Confirm Password
                <Input type="password" {...register("confirmPassword")} className="w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-4" />
                {renderError("confirmPassword")}
              </label>

              <label className="text-white">Full Name
                <Input {...register("fullName")} className=" w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-4" />
                {renderError("fullName")}
              </label>

              <label className="text-white">Email
                <Input {...register("email")} className=" w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-4" />
                {renderError("email")}
              </label>

              <label className="text-white">Phone
                <Input {...register("phoneNumber")} className="w-full px-4 py-3 rounded-lg bg-[#23243a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2 mb-4" />
